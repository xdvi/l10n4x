...
class Translator:
    ...
    def _setup_ffi(self):
        ...
        self._lib.l10n4c_translate_alloc.argtypes = [ctypes.c_char_p, ctypes.c_char_p]
    ...
    def translate(
        ...
        if params:
            ...
            ptr = self._lib.l10n4c_translate_with_params_alloc(
                c_locale, c_key, arr, len(params)
            )
        else:
            ptr = self._lib.l10n4c_translate_alloc(c_locale, c_key)
    ...
    def translate_buffered(self, locale: str, key: str) -> str:
        ...
        code = self._lib.l10n4c_translate_required_size(
            c_locale, c_key, ctypes.byref(out_size)
        )
        ...
        self._lib.l10n4c_translate(c_locale, c_key, buf, size)
