...
/// The requested locale has not been loaded. Call `l10n4c_load_lpk_directory` or
/// `l10n4c_load_lpk_locale` first.
...
/// Ed25519 signature verification failed — the `.lpk` file may have been tampered with.
...
/// before loading any `.lpk` files.
pub const L10N4C_VERIFY_KEY_NOT_SET: i32 = 9;
/// Library not initialized — call l10n4c_load_lpk_directory or l10n4c_load_lpk_locale first.
pub const L10N4C_NOT_INITIALIZED: i32 = 10;
/// AES decrypt key has not been configured. Required only for `L10E`-encrypted lpks.
/// Call `l10n4c_set_decrypt_key` before loading encrypted `.lpk` files.
...
pub fn core_error_to_ffi(err: l10n4x_core::CoreError) -> i32 {
    ...
    match err {
        ...
        CoreError::LocaleDataTooOld { .. } => L10N4C_RUNTIME_TOO_OLD,
        CoreError::InvalidStoreHandle(_) => L10N4C_INVALID_PARAMS,
